...
export const copy = {
  ...
  hero: {
    ...
    subheadline:
      "Odkrij 500 receptov za mehke, puhaste in okusne sladice, popolnoma brez glutena, mleka in sladkorja. Uživaj v vsakem grižljaju brez bolečin, slabe vesti ali odrekanja.",
